			...
			<table class="table table-border table-bordered table-bg table-hover table-sort" id="product_list">
				...
				<tbody>
					<tr class="text-c va-m">
						...
						<td rowspan="3">001</td>
						<td rowspan="3"><a onClick="product_show('哥本哈根橡木地板','product-show.html','10001')" href="javascript:;"><img width="60" class="product-thumb" src="pic/product/Thumb/6204.jpg"></a></td>
						<td rowspan="3"><a style="text-decoration:none" onClick="product_show('哥本哈根橡木地板','product-show.html','10001')" href="javascript:;">17D005</td>
						<td  width="60">玛莎紫</td>
						<td  width="40">30</td>
						<td  width="20"><input type="text" class="input-text text-c" value="1"></td>
						<td  width="20"><input type="text" class="input-text text-c" value="1"></td>
						<td  width="20"><input type="text" class="input-text text-c" value="1"></td>
						<td  width="20"><input type="text" class="input-text text-c" value="1"></td>
						<td  width="20"><input type="text" class="input-text text-c" value="1"></td>
						<td  width="60">5</td>
						<td width="100"><span class="price">145.0</span> </td>
						<td width="100"><span class="price">175.0</span> </td>
						<td width="100"><span class="price">1450.00</span></td>
					...
					<tr class="text-c va-m">
						...
						<td ><input type="text" class="input-text text-c" value="1"></td>
						<td >5</td>
						<td><span class="price">145.0</span> </td>
						<td><span class="price">175.0</span> </td>
						<td><span class="price">1450.00</span></td>
						<td class="f-14"><a style="text-decoration:none" class="ml-5" onClick="del_tr(this)" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
					</tr>
					<tr class="text-c va-m">
						<td >焦糖色</td>
					...
					<tr class="text-c va-m">
						...
						<td rowspan="2">002</td>
						<td rowspan="2"><a onClick="product_show('哥本哈根橡木地板','product-show.html','10001')" href="javascript:;"><img width="60" class="product-thumb" src="pic/product/Thumb/6204.jpg"></a></td>
						<td rowspan="2"><a style="text-decoration:none" onClick="product_show('哥本哈根橡木地板','product-show.html','10001')" href="javascript:;">17D007</td>
						<td >黑色+酒红</td>
						<td >88</td>
						<td ><input type="text" class="input-text text-c" value="1"></td>
						<td ><input type="text" class="input-text text-c" value="1"></td>
