	...
	<div class="pd-20">
		...
		<div class="row cl mt-20">
					...
					<div class="formControls col-5">
						<input type="text" id="manufacturer" placeholder="控制在25个字、50个字节以内" value="" class="input-text radius">
					</div>
					 ...
					 <%}else {
					  ...
					  %>
						<tr class="text-c va-m" id="p_<%=product.getId() %>_<%=pItem.getId() %>" >
							...
							<td><%=pItem.getNxxl() %></td>
							<td>
								<%=pItem.getNs()+pItem.getNm()+pItem.getNl()+pItem.getNxl()+pItem.getNxxl() %>
							 </td>
							<td><input type="text" class="input-text text-c" value="0"></td>
							<td>
							 </td>
							<td><input type="text" class="bk input-text text-c" value=""></td>
							<td><input type="text" class="input-text text-c" value="${m3date }"></td>
		...
		<div class="row cl mt-20">
					...
					<div class="formControls col-5">
						<input type="text" id="payBank" placeholder="控制在25个字、50个字节以内" value="" class="input-text radius">
					</div>
					<label class="form-label col-1 text-r"><span class="c-red">*</span>付款账户：</label>
					<div class="formControls col-5">
						<input type="text" id="payNo" placeholder="控制在25个字、50个字节以内" value="" class="input-text radius">
					</div>
				</div>
		<div class="row cl mt-20">
					<label class="form-label col-1 text-r"><span class="c-red">*</span>联系人：</label>
					<div class="formControls col-5">
						<input type="text" id="linkStaff" placeholder="控制在25个字、50个字节以内" value="" class="input-text radius">
					</div>
					<label class="form-label col-1 text-r"><span class="c-red">*</span>联系电话：</label>
					<div class="formControls col-5">
						<input type="text" id="telphone" placeholder="控制在25个字、50个字节以内" value="" class="input-text radius">
					</div>
				</div>
		<div class="row cl mt-20">
					<label class="form-label col-1 text-r"><span class="c-red">*</span>工厂地址：</label>
					<div class="formControls col-11">
						<input type="text" id="manufacturerAddress" placeholder="控制在25个字、50个字节以内" value="" class="input-text radius">
					</div>
				</div>
		<div class="row cl  mt-20">
		...
		$.ajax({ 
	        ...
	        success:function(data){ 
	        	if(data.success){
	        		...
	        		//var t=window.parent; 
	        		location.replace('production/getprodt.do?rid='+data.obj);
	        	}else 
